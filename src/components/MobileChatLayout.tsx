...
import FriendReqOption from "./FriendReqOption";
    ...
    <div className="fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4">
      <div className="w-full flex justify-between items-center">
        <Link
          ...
          <span className="text-xl text-indigo-600 font-semibold custom-font ml-3 mb-1">
            SnapTalk
          </span>
        </Link>
                  ...
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl">
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        ...
                        <div className="text-xs font-semibold leading-6 text-gray-400 pb-2">
                          Your chats
                        </div>
